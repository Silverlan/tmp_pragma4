...
if with_pfm:
	...
	if with_all_pfm_modules:
		...
		add_pragma_module(
			name="pr_unirender",
			commitSha="7f151a587bfd060db889bc31f61bbf2381123aad",
			repositoryUrl="https://github.com/Silverlan/tmp_pr_cycles3.git"
		)
		add_pragma_module(
			name="pr_xatlas",
		...
		add_pragma_module(
			name="pr_davinci",
			commitSha="b2fff8a17420cf02cec70c1cb77c9f4f14c86030",
